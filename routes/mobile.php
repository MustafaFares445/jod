...
use App\Http\Controllers\Mobile\PersonalCampaignController;
...
Route::middleware(['auth:sanctum', 'mobile-access-token'])->group(function (): void {
    ...
    Route::prefix('me')->name('me.')->group(function (): void {
        ...
        Route::patch('donations/{donation}/accept', [DonationController::class, 'accept'])->name('donations.accept');
        Route::patch('donations/{donation}/contact', [DonationController::class, 'contact'])->name('donations.contact');
        Route::patch('donations/{donation}/agree', [DonationController::class, 'agree'])->name('donations.agree');
        ...
        Route::get('campaigns', [PersonalCampaignController::class, 'index'])->name('campaigns.index');
        Route::post('campaigns', [PersonalCampaignController::class, 'store'])->name('campaigns.store');
        Route::get('campaigns/{campaign}', [PersonalCampaignController::class, 'show'])->name('campaigns.show');
        Route::patch('campaigns/{campaign}', [PersonalCampaignController::class, 'update'])->name('campaigns.update');
        Route::post('campaigns/{campaign}/close', [PersonalCampaignController::class, 'close'])->name('campaigns.close');
