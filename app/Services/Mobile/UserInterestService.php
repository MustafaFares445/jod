...
{
    public function adjustBehavioralWeight(User $user, Category $category, float $delta): void
    {
        DB::transaction(function () use ($user, $category, $delta): void {
            ...
            $interest->behavioral_weight = max($minimum, min($maximum, $interest->behavioral_weight + $delta));
