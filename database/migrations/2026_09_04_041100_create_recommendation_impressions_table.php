...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('recommendation_impressions', function (Blueprint $table): void {
            ...
            $table->index(['user_id', 'subject_type', 'subject_id', 'shown_at'], 'rec_impression_user_subject_idx');
        });
    }

    public function down(): void { Schema::dropIfExists('recommendation_impressions'); }
};
